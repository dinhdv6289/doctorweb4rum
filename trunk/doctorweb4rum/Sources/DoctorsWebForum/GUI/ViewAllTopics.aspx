<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="ViewAllTopics.aspx.cs" Inherits="GUI_ViewAllTopics" Title="View Topics" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="threadlist" class="threadlist">
        ...
        <%             Topic[] topics = BLL.TopicBLL.ViewAllTopicsByMemberID(Convert.ToInt32(memberID));
                       if (topics.Length > 0)
                       {
                            ...
                            <dl class="threadlastpost td">
                                ...
                                <dd>
                                    ...
                                    <em class="time"></em><a href="TopicDetails.aspx?topicIDLastPost=<%#Eval("TopicID") %>"
                                        ...
                                        <img title="Go to last post" src="Images/lastpost-right.png" alt="Go to last post"></a>
                                </dd>
                            </dl>
                        </div>
                    </li>
