...
ALTER TABLE ChatMessages ADD CONSTRAINT FK_ChatMessages_MemberID FOREIGN KEY (MemberID) REFERENCES Members(MemberID) ON UPDATE CASCADE ON DELETE CASCADE
