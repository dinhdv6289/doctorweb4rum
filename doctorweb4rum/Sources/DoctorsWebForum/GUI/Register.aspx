            ...
            <div class="section">
                ...
                <div class="blockrow">
                    ...
                    <div class="rightcol">
                        ...
                        <label class="error checked" generated="true" for="txtUserName">
                            &nbsp;</label>
                        ...
                        <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="User Name is used !"
                            ControlToValidate="txtUserName" Display="Static" OnServerValidate="CustomValidator1_ServerValidate"
                ...
                <div class="blockrow">
                    ...
                    <div class="rightcol">
                        ...
                        <label class="error" generated="true" for="txtPassword">&nbsp;</label>
                    ...
                    <div class="rightcol">
                        <asp:TextBox ID="txtConfirmPassword" runat="server" CssClass="primary textbox" TextMode="Password" ></asp:TextBox>
                        <label class="error" generated="true" for="txtConfirmPassword">&nbsp;</label>
                    ...
                    <div class="blockrow">
                        ...
                        <div class="rightcol">
                            ...
                            <label class="error" generated="true" for="txtEmail">&nbsp;</label>
                        ...
                        <div class="rightcol">
                            <asp:TextBox ID="txtConfirmEmail" runat="server" CssClass="primary textbox"></asp:TextBox>
                            <label class="error" generated="true" for="txtConfirmEmail">&nbsp;</label>
