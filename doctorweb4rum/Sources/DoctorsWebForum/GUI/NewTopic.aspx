...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="vbform block">
                ...
                <div class="blockrow">
                    ...
                    <div style="padding: 10px;">
                        <span class="bold" style="color: #ff0000;">
                            <asp:Label ID="lblErrors" runat="server"></asp:Label></span>
                        <br>
                        <br>
                    </div>
                </div>
                <div class="blockrow">
                    You are creating a new thread in <span class="bold">
                    ...
                    <div style="padding: 10px;">
                        ...
                        <li>
                            <label for="cb_confirm_forum">
                                ...
                                I believe <span class="bold">
                                    <%= GetSubForumBySubForumID().SubForumName %>
                                </span>is the BEST section for this topic</label>
                        </li>
                    </div>
                </div>
                <div class="blockrow">
        ...
        <div class="blockfoot actionbuttons">
            <div class="group">
                <asp:Button ID="btnSubmitNewTopic" runat="server" Text="Submit New Topic" CssClass="button"
                    OnClick="btnSubmitNewTopic_Click" />
