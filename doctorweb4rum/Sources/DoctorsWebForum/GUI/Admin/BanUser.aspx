...
<asp:Panel id="panelBanUser" runat="server">
                ...
                <div class="section">
                    <div class="blockrow">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatortxtUserName" runat="server" ControlToValidate="txtUserName" ErrorMessage="UserName is required" ></asp:RequiredFieldValidator>
                    </div>
            ...
            <H2 id="H2_3" class="blocksubhead" align=center>Message Forum</H2><DIV class="section"><DIV class="blockrow">Invalid User Specified </DIV><FIELDSET class="blockrow"><asp:Button id="btnBack" runat="server" CssClass="button" Text="Go Back" OnClick="btnBack_Click">
                        ...
                        <asp:Panel id="panelHasBeenBanned" runat="server">
                <h2 id="H2_5" class="blocksubhead" align="center">
                    Message Forum</h2>
                    <asp:Timer id="TimerHasBeenBanned" runat="server" Interval="1000" OnTick="Timer3_Tick"></asp:Timer>
                <div class="section">
                    <div class="blockrow">
                        User <strong><asp:Label ID="lblUserBanHasBeenBanned" runat="server"></asp:Label> </strong> has been banned until everlasting.
                    </div>
                    <fieldset class="blockrow">
